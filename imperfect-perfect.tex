...
\]
in which the horizontal arrows are surjective (these are the \emph{theta maps} of $p$-adic Hodge theory; see \cite[Lemma~1.3.3(c)]{kedlaya-new-phigamma}), the surjectivity
