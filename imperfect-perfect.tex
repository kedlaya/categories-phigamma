...
\date{\textit{unstable draft}; version of November 8, 2015}
...
let $C_G(M)$ denote the complex of inhomogeneous continuous cochains on $G$ with values in $M$. Denote by $H^i_G(M)$ the cohomology groups of this complex.
...
Theorem~\ref{T:tilde no tilde}. Then $C_{\Gamma_K}(\tilde{M} \boxtimes \Dfm_{K})$ 
is canonically quasi-isomorphic to...
\end{theorem}
