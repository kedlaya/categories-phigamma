...
For additional applications in Iwasawa theory, one needs also the following characterization of the kernel of $\psi$.
\begin{defn}
...
\begin{remark}
\textbf{insert some remark about $M^{\psi=0}$ and its relevance}
\end{remark}
